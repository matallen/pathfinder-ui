			    ...
			    $('#example').DataTable( {
			        ...
			        ,"columnDefs": [
				      	 { "targets": 2, "orderable": false, "render": function (data,type,row){
									return "<div class='btn btn-image' title='Edit' onclick='load(\""+row["Id"]+"\");' data-toggle='modal' data-target='#exampleModal' style='width:32px;height:32px;background-image: url(https://cdn2.iconfinder.com/data/icons/web/512/Wrench-32.png); background-repeat: no-repeat'></div>";
								}}
